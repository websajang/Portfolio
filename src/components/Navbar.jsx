    ...
    return(
        <>
            ...
            <div className="hidden lg:flex flex-row justify-end w-full p-5 gap-10 -ml-10 font-lexend">
                ...
                <a href="/how-it-works" className="text-xl cursor-pointer hover:underline hover:underline-offset-8">Tecnologies</a>
                <a href="/#" className="text-xl cursor-pointer hover:underline hover:underline-offset-8">Webpages</a>
